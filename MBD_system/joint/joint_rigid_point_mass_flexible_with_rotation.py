...
class JointRigidPointMassFlexibleWithRotation(Joint):
    """
    ...
    def __init__(self, body_id_i, body_id_j, u_iP=np.zeros(2, dtype=float), node_id_j=None, properties_dict={}, parent=None):
        ...
        :return:
        """
        self.joint_type = "rigid joint point mass-flexible with rotation"
        super(JointRigidPointMassFlexibleWithRotation, self).__init__(self.joint_type, body_id_i, body_id_j, u_iP_CAD=u_iP, properties_dict=properties_dict, parent=parent)
