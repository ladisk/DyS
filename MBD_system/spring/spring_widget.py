...
#         self.setAttribute(QtCore.Qt.WA_DeleteOnClose)
    ...
    def edit(self, item=None):
        ...
        #   uPi, uPj
        for uP_lineEdit, u_P in zip([self.ui.uPi_lineEdit, self.ui.uPj_lineEdit], item.u_P_LCS_list):

            uP_lineEdit.setText(array2string(u_P))
        # #   uPj
        ...
        #   force scale
        self.ui.scale_lineEdit.setText(str(item._Fn_list[0]._scale_GL))

        #   force color
        self.ui.color_lineEdit.setText(array2string(item._Fn_list[0]._color_GL))
