...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        Form.setMinimumSize(QtCore.QSize(402, 709))
        ...
        self.gridLayout.addWidget(self.bodyID_label_2, 4, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.bodyID_lineEdit, 1, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.data_file_lineEdit, 5, 0, 1, 3)
        ...
        self.load_data_pushButton.setMaximumSize(QtCore.QSize(16777215, 28))
        self.load_data_pushButton.setObjectName(_fromUtf8("load_data_pushButton"))
        self.gridLayout.addWidget(self.load_data_pushButton, 4, 2, 1, 1)
        ...
        self.MBD_ID_label = QtGui.QLabel(self.groupBox_basicInfo)
        self.MBD_ID_label.setObjectName(_fromUtf8("MBD_ID_label"))
        self.gridLayout.addWidget(self.MBD_ID_label, 2, 0, 1, 1)
        self.MBD_ID_lineEdit = QtGui.QLineEdit(self.groupBox_basicInfo)
        self.MBD_ID_lineEdit.setEnabled(False)
        self.MBD_ID_lineEdit.setObjectName(_fromUtf8("MBD_ID_lineEdit"))
        self.gridLayout.addWidget(self.MBD_ID_lineEdit, 2, 2, 1, 1)
        self.verticalLayout.addWidget(self.groupBox_basicInfo)
        self.tabWidget = QtGui.QTabWidget(Form)
        self.tabWidget.setMinimumSize(QtCore.QSize(439, 263))
        self.tabWidget.setMaximumSize(QtCore.QSize(439, 263))
        self.tabWidget.setObjectName(_fromUtf8("tabWidget"))
        self.tab = QtGui.QWidget()
        self.tab.setObjectName(_fromUtf8("tab"))
        self.gridLayout_4 = QtGui.QGridLayout(self.tab)
        self.gridLayout_4.setObjectName(_fromUtf8("gridLayout_4"))
        self.dtheta_lineEdit = QtGui.QLineEdit(self.tab)
        self.dtheta_lineEdit.setObjectName(_fromUtf8("dtheta_lineEdit"))
        self.gridLayout_4.addWidget(self.dtheta_lineEdit, 5, 2, 1, 1)
        self.transformCS_label = QtGui.QLabel(self.tab)
        self.transformCS_label.setObjectName(_fromUtf8("transformCS_label"))
        self.gridLayout_4.addWidget(self.transformCS_label, 6, 0, 1, 1)
        self.mass_label = QtGui.QLabel(self.tab)
        self.mass_label.setObjectName(_fromUtf8("mass_label"))
        self.gridLayout_4.addWidget(self.mass_label, 0, 0, 1, 1)
        self.dR_lineEdit = QtGui.QLineEdit(self.tab)
        self.dR_lineEdit.setObjectName(_fromUtf8("dR_lineEdit"))
        self.gridLayout_4.addWidget(self.dR_lineEdit, 4, 2, 1, 1)
        self.R_label = QtGui.QLabel(self.tab)
        self.R_label.setObjectName(_fromUtf8("R_label"))
        self.gridLayout_4.addWidget(self.R_label, 2, 0, 1, 1)
        self.theta_label = QtGui.QLabel(self.tab)
        self.theta_label.setObjectName(_fromUtf8("theta_label"))
        self.gridLayout_4.addWidget(self.theta_label, 3, 0, 1, 1)
        self.transformCS_comboBox = QtGui.QComboBox(self.tab)
        self.transformCS_comboBox.setObjectName(_fromUtf8("transformCS_comboBox"))
        self.transformCS_comboBox.addItem(_fromUtf8(""))
        self.transformCS_comboBox.addItem(_fromUtf8(""))
        self.gridLayout_4.addWidget(self.transformCS_comboBox, 6, 2, 1, 1)
        self.R_lineEdit = QtGui.QLineEdit(self.tab)
        self.R_lineEdit.setObjectName(_fromUtf8("R_lineEdit"))
        self.gridLayout_4.addWidget(self.R_lineEdit, 2, 2, 1, 1)
        self.J_lineEdit = QtGui.QLineEdit(self.tab)
        self.J_lineEdit.setObjectName(_fromUtf8("J_lineEdit"))
        self.gridLayout_4.addWidget(self.J_lineEdit, 1, 2, 1, 1)
        self.J_label = QtGui.QLabel(self.tab)
        self.J_label.setObjectName(_fromUtf8("J_label"))
        self.gridLayout_4.addWidget(self.J_label, 1, 0, 1, 1)
        self.dtheta_label = QtGui.QLabel(self.tab)
        self.dtheta_label.setObjectName(_fromUtf8("dtheta_label"))
        self.gridLayout_4.addWidget(self.dtheta_label, 5, 0, 1, 1)
        self.dR_label = QtGui.QLabel(self.tab)
        self.dR_label.setObjectName(_fromUtf8("dR_label"))
        self.gridLayout_4.addWidget(self.dR_label, 4, 0, 1, 1)
        self.m_lineEdit = QtGui.QLineEdit(self.tab)
        self.m_lineEdit.setObjectName(_fromUtf8("m_lineEdit"))
        self.gridLayout_4.addWidget(self.m_lineEdit, 0, 2, 1, 1)
        self.theta_lineEdit = QtGui.QLineEdit(self.tab)
        self.theta_lineEdit.setObjectName(_fromUtf8("theta_lineEdit"))
        self.gridLayout_4.addWidget(self.theta_lineEdit, 3, 2, 1, 1)
        ...
        self.forces_listWidget = QtGui.QListWidget(self.tab_2)
        self.forces_listWidget.setObjectName(_fromUtf8("forces_listWidget"))
        self.gridLayout_2.addWidget(self.forces_listWidget, 0, 0, 1, 1)
        self.tabWidget.addTab(self.tab_2, _fromUtf8(""))
        self.tab_3 = QtGui.QWidget()
        self.tab_3.setObjectName(_fromUtf8("tab_3"))
        self.gridLayout_5 = QtGui.QGridLayout(self.tab_3)
        self.gridLayout_5.setObjectName(_fromUtf8("gridLayout_5"))
        self.markers_listWidget = QtGui.QListWidget(self.tab_3)
        self.markers_listWidget.setObjectName(_fromUtf8("markers_listWidget"))
        self.gridLayout_5.addWidget(self.markers_listWidget, 0, 0, 1, 1)
        self.tabWidget.addTab(self.tab_3, _fromUtf8(""))
        self.tab_4 = QtGui.QWidget()
        self.tab_4.setObjectName(_fromUtf8("tab_4"))
        self.verticalLayout_2 = QtGui.QVBoxLayout(self.tab_4)
        self.verticalLayout_2.setObjectName(_fromUtf8("verticalLayout_2"))
        self.geometry_listWidget = QtGui.QListWidget(self.tab_4)
        self.geometry_listWidget.setObjectName(_fromUtf8("geometry_listWidget"))
        self.verticalLayout_2.addWidget(self.geometry_listWidget)
        self.tabWidget.addTab(self.tab_4, _fromUtf8(""))
        self.verticalLayout.addWidget(self.tabWidget, QtCore.Qt.AlignHCenter)
        ...
        self.gridLayout_3.addWidget(self.color_lineEdit, 6, 2, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.transparent_lineEdit, 7, 2, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.centerOfMass_lineEdit, 0, 2, 1, 1)
        ...
        self.display_style_comboBox.addItem(_fromUtf8(""))
        self.display_style_comboBox.addItem(_fromUtf8(""))
        self.gridLayout_3.addWidget(self.display_style_comboBox, 8, 2, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.geometrySTLfile_lineEdit, 4, 0, 1, 3)
        ...
        self.load_geometry_pushButton.setMinimumSize(QtCore.QSize(0, 28))
        self.load_geometry_pushButton.setObjectName(_fromUtf8("load_geometry_pushButton"))
        self.gridLayout_3.addWidget(self.load_geometry_pushButton, 2, 2, 1, 1)
        ...
        Form.setTabOrder(self.bodyID_lineEdit, self.centerOfMass_lineEdit)
        Form.setTabOrder(self.centerOfMass_lineEdit, self.color_lineEdit)
    ...
    def retranslateUi(self, Form):
        ...
        self.MBD_ID_label.setText(_translate("Form", "MBD id", None))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), _translate("Form", "Sim.Params", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), _translate("Form", "Forces", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_3), _translate("Form", "Markers", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_4), _translate("Form", "Geometry", None))
