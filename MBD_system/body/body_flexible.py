...
class FlexibleBody(Body):
    ...
    def evaluate_contact_geometry(self, element_id, ksi, q):
        """

        Returns:

        """
        t_i, n_i = self.mesh.evaluate_contact_geometry(element_id, ksi, q)
    ...
    def print_gradients(self):
        ...
        """
        print "Mesh gradients:"
        print self.mesh.evaluate_gradients

    def evaluate_mesh_data_at_position(self, L, element_id=None):
        """

        :return:
        """
        # print '---evaluate_mesh_data_at_position---'
        # print 'L, element_id=', L, element_id
        ksi, element_id, node_id, L_i = self.mesh.evaluate_ksi_element_id_node_id_at_position(L, element_id)
