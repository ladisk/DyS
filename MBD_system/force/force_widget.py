...
#         self.setAttribute(QtCore.Qt.WA_DeleteOnClose)
    ...
    def _save(self, item=None):
        ...
        if self.item is not None:
            ...
            self.item._scale_GL, status = self.ui.scale_lineEdit.text().toFloat()
    ...
    def edit(self, item=None):
        ...
        for i, solution_container in enumerate(self.item._solution_containers):
            self.ui.tableWidget.setItem(0, i, QtGui.QTableWidgetItem(str(len(getattr(self.item, solution_container)))))
