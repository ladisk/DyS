...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        Form.setMinimumSize(QtCore.QSize(317, 536))
        Form.setMaximumSize(QtCore.QSize(317, 536))
        ...
        self.loadSolutionFileStatus = QtGui.QCheckBox(self.info)
        self.loadSolutionFileStatus.setObjectName(_fromUtf8("loadSolutionFileStatus"))
        self.gridLayout_4.addWidget(self.loadSolutionFileStatus, 0, 0, 1, 1)
